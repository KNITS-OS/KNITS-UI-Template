...
export const createGroup = body => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
...
export const searchGroup = id => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
...
export const updateGroup = (id, body) => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
...
export const deleteGroup = id => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
...
export const deactivateGroup = id => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
...
export const addCareMemberToGroup = (id, body) => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
...
export const removeCareMemberFromGroup = (id, body) => async (dispatch: Dispatch<AnyAction>) => {
  try {
    dispatch({
