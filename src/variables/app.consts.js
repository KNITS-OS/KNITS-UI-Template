...
export const Permission = {
  ...
  CareMember_read: 2,
  CareMember_write: 3,
  CareMember_country_all: 4,
  BestPractice_read: 5,
  BestPractice_write: 6,
  Group_read: 7,
  Group_write: 8,
  Group_country_all: 9,
  Group_user_all: 10,
  Email_write: 11,
  Email_country_all: 12,
  Dashboard_worldview_read: 13,
  Dashboard_statistics_read: 14,
  Dashboard_statistics_country_all: 15,
};
